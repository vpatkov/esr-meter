/*
 * Blocking delays in active mode. The duration of the delay
...
#ifndef __OPTIMIZE__
#  error "Optimization must be enabled"
#endif
...
#include <math.h>  /* For compile-time calculations (doesn't need -lm) */
